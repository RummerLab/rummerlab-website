      ...
      {publications.length > 0 && (
        <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {publications.map((publication: Publication, index: number) => {
            ...
            return (
              <li key={index} className="bg-gray-50 dark:bg-gray-800 shadow-lg rounded-xl p-6 list-none transition-all duration-200 hover:shadow-xl h-full flex flex-col">
