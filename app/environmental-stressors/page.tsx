        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="relative rounded-xl overflow-hidden mb-12">
                ...
                <div className="relative z-10 px-8 py-16 text-white">
                    <h1 className="text-4xl font-bold mb-4">Whole-animal responses to environmental stress</h1>
            ...
            <div className="grid lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <section className="bg-white rounded-xl shadow-lg p-8">
                        <h2 className="text-2xl font-bold text-gray-900 mb-6">RESEARCH THEME - 1: Whole-animal responses to environmental stress</h2>
                        <div className="prose prose-lg max-w-none">
                            ...
                            <h3 className="text-xl font-semibold mt-8 mb-4">Key Publications</h3>
                            <ul className="space-y-4">
                                <li className="flex gap-2">
                                    ...
                                    <a href="http://www.tandfonline.com/doi/abs/10.1577/T04-235.1#.VCkCGimSydw" className="text-blue-600 hover:text-blue-800">doi:10.1577/T04-235.1</a>
                                </li>
                            </ul>

                            <div className="my-8 p-6 bg-blue-50 rounded-lg">
                                <h3 className="text-xl font-semibold mb-4">Recent Research Focus</h3>
                            ...
                            <h3 className="text-xl font-semibold mt-8 mb-4">Thermal Acclimation Studies</h3>
                    ...
                    <section className="bg-white rounded-xl shadow-lg p-8">
                        <h2 className="text-2xl font-bold text-gray-900 mb-6">Larval Fish Research</h2>
                        <div className="prose prose-lg max-w-none">
                            <div className="my-8 relative h-64 rounded-lg overflow-hidden">
                                <Image
                            ...
                            <p>While much of my whole-animal work has been done on adult fishes, I have integrated several studies on larval fishes into my program. I recently collaborated with Dr. Shaun Killen to understand the tradeoffs between dominant behaviours and aerobic metabolic scope in larval coral reef damselfish.</p>
                        </div>
                    </section>
                </div>
                ...
                <div className="lg:col-span-1 space-y-8">
                    <aside className="bg-white rounded-xl shadow-lg p-6">
                        <h3 className="text-xl font-bold text-gray-900 mb-4">Research Highlights</h3>
                        <ul className="space-y-4">
                            <li className="flex items-start gap-4">
                                ...
                                <div>
                                    <h4 className="font-semibold">Shark Physiology</h4>
                                    <p className="text-sm text-gray-600">Understanding how sharks respond to environmental stressors</p>
                                </div>
                            </li>
                            <li className="flex items-start gap-4">
                                <div className="relative w-20 h-20 flex-shrink-0">
                                ...
                                <div>
                                    <h4 className="font-semibold">Ocean Acidification</h4>
                                    <p className="text-sm text-gray-600">Effects on marine species adaptation and survival</p>
                                </div>
                            </li>
                        </ul>
                    </aside>
                    ...
                    <aside className="bg-white rounded-xl shadow-lg p-6">
                        ...
                        <p className="text-gray-600">Our research contributes to understanding and protecting marine ecosystems in the face of environmental change.</p>
                    </aside>
                </div>
            </div>
        </div>
